...
export default function Dashboard({ address }: DashboardProps) {
  ...
  const [selectedExpenseDate, setSelectedExpenseDate] = useState<string>(new Date().toISOString().split('T')[0])
      ...
      case 'calendar':
        return (
          <div className="space-y-6">
            {/* Calendar Header */}
            <div className="text-center mb-6">
              <h1 className="text-3xl font-bold text-white pixelated-text mb-2">Calendar View</h1>
              <p className="text-blue-300 pixelated-text">Track your daily entries and activities</p>
            </div>
              ...
              <CardContent>
                ...
                <div className="grid grid-cols-7 gap-1">
                  ...
                  {generateCalendarDays().map((day, index) => (
                    ...
                    >
                      {day ? (
                        <div className={`relative w-8 h-8 mx-auto rounded-lg flex items-center justify-center text-sm pixelated-text ${
                          isToday(day)
              ...
              <CardContent>
                {hasEntriesForDate(selectedDate.getDate()) ? (
                  <div className="space-y-3">
                    {entries
                      .filter(entry => entry.date === `${selectedYear}-${String(selectedMonth + 1).padStart(2, '0')}-${String(selectedDate.getDate()).padStart(2, '0')}`)
                      .map((entry, index) => (
                        <div key={index} className="bg-slate-700/50 rounded-lg p-3 border border-slate-600/30">
                          <div className="flex items-center justify-between mb-2">
                            <span className="text-white pixelated-text font-semibold">{entry.content}</span>
                          ...
                          {entry.tags.length > 0 && (
                            <div className="flex items-center gap-2">
                              ...
                              <div className="flex gap-1">
                                {entry.tags.map((tag, tagIndex) => (
                                  <Badge key={tagIndex} className="bg-blue-500/20 text-blue-300 border-blue-400/30 pixelated-text text-xs">
                                    #{tag}
                                  </Badge>
                                ))}
                              </div>
                  ...
                  <div className="text-center py-8">
                    ...
                    <h3 className="text-xl font-semibold text-white pixelated-text mb-2">No Entries</h3>
                    <p className="text-blue-300 text-center mb-4">
                      No entries for this date. Start your day by adding a new entry!
                    </p>
                    <Button
            ...
            <Card className="bg-slate-800/50 border-slate-600 text-white backdrop-blur-sm card-glass">
              <CardHeader>
                <CardTitle className="text-blue-300 pixelated-text">This Month's Activity</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="text-center p-4 bg-slate-700/50 rounded-lg border border-slate-600/30">
                    ...
                    <div className="text-sm text-blue-300 pixelated-text">Active Days</div>
                  </div>
                  <div className="text-center p-4 bg-slate-700/50 rounded-lg border border-slate-600/30">
                    <div className="text-2xl font-bold text-purple-400 pixelated-text mb-1">
                      {getDaysInMonth(currentYear, currentMonth)}
                    </div>
                    <div className="text-sm text-blue-300 pixelated-text">Days in Month</div>
                  </div>
                </div>
              </CardContent>
            </Card>
      ...
      case 'streak':
        return (
          <div className="space-y-6">
            ...
            <Card className="bg-slate-800/50 border-slate-600 text-white backdrop-blur-sm card-glass">
              <CardHeader>
                <CardTitle className="text-blue-300 pixelated-text">Streak History</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="text-center py-8">
                  <Flame className="w-16 h-16 text-orange-400 mb-4 mx-auto opacity-50" />
                  <h3 className="text-xl font-semibold text-white pixelated-text mb-2">Streak History Coming Soon</h3>
                  <p className="text-blue-300 text-center mb-6 max-w-md mx-auto">
                    Track your longest streaks, milestones, and streak achievements over time.
                  </p>
            ...
            <Card className="bg-slate-800/50 border-slate-600 text-white backdrop-blur-sm card-glass">
              <CardHeader>
                <CardTitle className="text-blue-300 pixelated-text">Streak Goals</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-slate-700/50 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-white pixelated-text">7 Day Streak</div>
                        <div className="text-sm text-blue-300">Complete 7 consecutive days</div>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-slate-700/50 rounded-lg">
                    <div className="flex items-center gap-3">
                      <Target className="w-5 h-5 text-blue-400" />
                      <div>
                        <div className="text-white pixelated-text">30 Day Streak</div>
                        <div className="text-sm text-blue-300">Complete 30 consecutive days</div>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-slate-700/50 rounded-lg">
                    <div className="flex items-center gap-3">
                      <Target className="w-5 h-5 text-blue-400" />
                      <div>
                        <div className="text-white pixelated-text">100 Day Streak</div>
                        <div className="text-sm text-blue-300">Complete 100 consecutive days</div>
                      </div>
                    </div>
                    <Badge className="bg-slate-500/20 text-slate-300 border-slate-400/30 pixelated-text">
                      Locked
        ...
        return (
          <div className="space-y-8">
            ...
            <div className="text-center mb-12">
              <h1 className="text-4xl font-bold text-white mb-3">Basio Calculator</h1>
              <p className="text-slate-400 text-lg">Advanced crypto calculation suite</p>
            </div>

            {/* Calculator Tabs */}
            <div className="flex flex-wrap gap-3 justify-center mb-8">
              {[
                { id: 'gas', label: 'GAS CALCULATOR', icon: Calculator, color: 'from-red-500 to-orange-500' },
                { id: 'currency', label: 'CURRENCY SWAP', icon: Target, color: 'from-green-500 to-emerald-500' },
                { id: 'expense', label: 'EXPENSE JOURNAL', icon: BookOpen, color: 'from-purple-500 to-pink-500' },
                { id: 'analytics', label: 'ANALYTICS', icon: BarChart3, color: 'from-blue-500 to-indigo-500' }
              ].map((tab) => {
                const Icon = tab.icon
                return (
                  <Button
            ...
            {activeCalculatorTab === 'gas' && (
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-8">
                  <h2 className="text-2xl font-semibold text-white mb-2">Gas Fee Calculator</h2>
                  <p className="text-slate-400">Calculate transaction costs with precision</p>
                </div>
                                <div className="space-y-6">
                  {/* Gas Parameters */}
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-slate-300">Gas Price (Gwei)</label>
                      <input
                        type="number"
                        value={gasPrice}
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-slate-300">Gas Limit</label>
                      <input
                        type="number"
                        value={gasLimit}
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-slate-300">ETH Price (USD)</label>
                      <input
                        type="number"
                        value={ethPrice}
                  ...
                  <div className="bg-slate-800/50 rounded-xl p-8 border border-slate-700">
                    <h4 className="text-white font-semibold mb-6 text-center text-lg">Calculation Results</h4>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div className="text-center p-6 bg-slate-700/50 rounded-lg">
                        <div className="text-3xl font-bold text-blue-400 mb-2">{gasFeeResult.gwei}</div>
                        <div className="text-sm text-slate-400">Gwei</div>
                      </div>
                      <div className="text-center p-6 bg-slate-700/50 rounded-lg">
                        <div className="text-3xl font-bold text-green-400 mb-2">{gasFeeResult.eth}</div>
                        <div className="text-sm text-slate-400">ETH</div>
                      </div>
                      <div className="text-center p-6 bg-slate-700/50 rounded-lg">
                        <div className="text-3xl font-bold text-purple-400 mb-2">${gasFeeResult.usd}</div>
            ...
            {activeCalculatorTab === 'currency' && (
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-8">
                  <h2 className="text-2xl font-semibold text-white mb-2">Currency Converter</h2>
                  <p className="text-slate-400">Convert currencies with real-time exchange rates</p>
                  {isLoadingRates && (
                    <div className="flex items-center justify-center gap-2 mt-2">
                      <div className="w-4 h-4 border-2 border-blue-400 border-t-transparent rounded-full animate-spin"></div>
                      <span className="text-xs text-blue-300 pixelated-text">Updating rates...</span>
                    </div>
                  )}
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-slate-300">From Currency</label>
                      <select
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-slate-300">To Currency</label>
                      <select
                  ...
                  {/* Conversion Results */}
                  <div className="bg-slate-800/50 rounded-xl p-8 border border-slate-700">
                    <h4 className="text-white font-semibold mb-6 text-center text-lg">Conversion Results</h4>
                    <div className="text-center">
                      <div className="text-4xl font-bold text-blue-400 mb-3">
                        {getCurrencySymbol(currencySwap.fromCurrency)}{parseFloat(currencySwap.fromAmount || '0').toFixed(2)}
                      </div>
                      <div className="text-slate-400 mb-4 text-lg">equals</div>
                      <div className="text-4xl font-bold text-green-400 mb-4">
                        {getCurrencySymbol(currencySwap.toCurrency)}{convertedAmount.toFixed(2)}
                      </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="text-center p-4 bg-slate-700/50 rounded-lg">
                      ...
                      <div className="text-xs text-slate-400">
                        = {getCurrencySymbol(currencySwap.toCurrency)}{currencySwap.exchangeRate.toFixed(4)}
                      </div>
                    </div>
                    <div className="text-center p-4 bg-slate-700/50 rounded-lg">
                      ...
                      <div className="text-xs text-slate-400">
                        = {getCurrencySymbol(currencySwap.fromCurrency)}{(1 / currencySwap.exchangeRate).toFixed(4)}
                      </div>
                    </div>
                    <div className="text-center p-4 bg-slate-700/50 rounded-lg">
                      ...
                      <div className="text-xs text-slate-400">
                        = {getCurrencySymbol(currencySwap.toCurrency)}{(100 * currencySwap.exchangeRate).toFixed(2)}
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {activeCalculatorTab === 'expense' && (
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-8">
                  <h2 className="text-2xl font-semibold text-white mb-2">Expense Journal</h2>
                  <p className="text-slate-400">Track and manage your crypto expenses</p>
                </div>
                
                <div className="space-y-6">
                  {/* Expense Entry Form */}
                  <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700">
                    <h3 className="text-white font-semibold text-lg mb-6 text-center">Add New Expense</h3>
                        ...
                        <div className="space-y-2">
                          <label className="text-sm font-medium text-slate-300">Gas Fee (USD)</label>
                          <input
                            type="number"
                ...
                <Card className="bg-slate-800/50 border-slate-600 text-white backdrop-blur-sm card-glass">
                  <CardHeader className="text-center">
                    <CardTitle className="text-blue-300 pixelated-text text-2xl">Expense Journal</CardTitle>
                    <p className="text-blue-300/70 pixelated-text">Your complete expense history and tracking</p>
                  </CardHeader>
                  <CardContent>
                    {expenseEntries.length === 0 ? (
                      <div className="text-center py-12">
                        <BookOpen className="w-20 h-20 text-blue-400 mb-4 mx-auto opacity-50" />
                        <h3 className="text-xl font-semibold text-white pixelated-text mb-2">No Expenses Yet</h3>
                        <p className="text-blue-300 text-center mb-6 max-w-md mx-auto">
                          Start tracking your crypto expenses by adding your first expense entry above.
                        </p>
                      </div>
                    ) : (
                      <div className="space-y-4">
                        {expenseEntries.map((expense) => (
                          <div key={expense.id} className="bg-gradient-to-r from-slate-700/50 to-slate-600/50 rounded-xl p-6 border border-slate-500/30">
                            <div className="flex items-start justify-between mb-4">
                              <div className="flex items-center gap-4">
                                <Badge className="bg-blue-500/20 text-blue-300 border-blue-400/30 pixelated-text px-3 py-1">
                                  {expense.category}
                                </Badge>
                                <span className="text-sm text-blue-300 pixelated-text">{expense.date}</span>
                              </div>
                              <div className="flex items-center gap-3">
                            ...
                            <div className="mb-4">
                              <h4 className="text-white pixelated-text font-semibold text-lg">{expense.description}</h4>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                              {expense.gasFee && (
                                <div className="text-blue-300 pixelated-text bg-slate-600/30 rounded-lg p-3">
                                  <span className="font-semibold">Gas Fee:</span> ${parseFloat(expense.gasFee).toFixed(2)}
                                </div>
                              )}
                              {expense.transactionHash && (
                                <div className="text-blue-300 pixelated-text font-mono text-xs bg-slate-600/30 rounded-lg p-3">
                                  <span className="font-semibold">TX:</span> {expense.transactionHash.slice(0, 10)}...
                                </div>
                              )}
                              {expense.notes && (
            ...
            {activeCalculatorTab === 'analytics' && (
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-8">
                  <h2 className="text-2xl font-semibold text-white mb-2">Expense Analytics</h2>
                  <p className="text-slate-400">Comprehensive insights into your spending patterns</p>
                </div>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700">
                    <h4 className="text-white font-semibold mb-4 text-lg">Total Expenses</h4>
                    ...
                    <div className="space-y-3">
                      {expenseCategories.map(category => {
                        ...
                        if (total > 0) {
                          return (
                            <div key={category} className="flex justify-between items-center p-3 bg-slate-700/50 rounded-lg">
                  ...
                  <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700">
                    <h4 className="text-white font-semibold mb-4 text-lg">Recent Expenses</h4>
                    <div className="space-y-3">
                      {expenseEntries.slice(0, 5).map((expense) => (
                        <div key={expense.id} className="flex justify-between items-center p-3 bg-slate-700/50 rounded-lg">
                          <div>
                            <span className="text-white font-semibold">{expense.description}</span>
                            <span className="text-slate-400 ml-2 text-sm">({expense.date})</span>
                          </div>
                          <span className="text-green-400 font-semibold">${parseFloat(expense.amount).toFixed(2)}</span>
                        </div>
                      ))}
                    </div>
                  </div>
      ...
      case 'stats':
        return (
          <div className="space-y-8">
            {/* Stats Header */}
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-white pixelated-text mb-2">Activity Statistics</h1>
              <p className="text-blue-300 pixelated-text">Track your DailyBase journey and progress</p>
            </div>

            {/* Key Metrics */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center p-6 bg-slate-800/30 rounded-lg border border-slate-600/30">
                <div className="text-4xl font-bold text-white pixelated-text mb-1">{entries.length}</div>
                <div className="text-sm text-blue-300 pixelated-text">Entries</div>
              </div>
              <div className="text-center p-6 bg-slate-800/30 rounded-lg border border-slate-600/30">
                <div className="text-4xl font-bold text-white pixelated-text mb-1">
                  {entries.length > 0 ? Math.ceil(entries.length / 7) : 0}
                </div>
                <div className="text-sm text-blue-300 pixelated-text">Weeks</div>
              </div>
              <div className="text-center p-6 bg-slate-800/30 rounded-lg border border-slate-600/30">
                <div className="text-4xl font-bold text-white pixelated-text mb-1">
                  {entries.length > 0 ? Math.round((entries.length / 30) * 100) : 0}%
                </div>
              ...
              <div className="text-center p-6 bg-slate-800/30 rounded-lg border border-slate-600/30">
                ...
                <div className="text-sm text-blue-300 pixelated-text">Streak</div>
              </div>
            </div>
            ...
            <div className="bg-slate-800/30 rounded-lg border border-slate-600/30 p-6">
              <div className="text-center mb-6">
                <h3 className="text-xl font-semibold text-white pixelated-text mb-2">Activity</h3>
                <p className="text-sm text-blue-300 pixelated-text">Daily contribution pattern</p>
              </div>
            ...
            {/* Recent Activity */}
            <div className="bg-slate-800/30 rounded-lg border border-slate-600/30 p-6">
              <h3 className="text-xl font-semibold text-white pixelated-text mb-4">Recent</h3>
              {entries.length === 0 ? (
                <div className="text-center py-8">
                ...
                <div className="space-y-3">
                  {entries.slice(0, 3).map((entry, index) => (
                    <div key={entry.id} className="flex items-center gap-3 p-3 bg-slate-700/20 rounded-lg">
            ...
            {/* Monthly Breakdown */}
            <div className="bg-slate-800/30 rounded-lg border border-slate-600/30 p-6">
              <h3 className="text-xl font-semibold text-white pixelated-text mb-4">Monthly</h3>
              <div className="space-y-3">
                {Array.from({ length: 3 }, (_, i) => {
                  ...
                  return (
                    <div key={i} className="flex items-center justify-between p-3 bg-slate-700/20 rounded-lg">
                      <span className="text-blue-300 pixelated-text">{monthName}</span>
                      <div className="flex items-center gap-2">
                        <div className="w-16 bg-slate-600/50 rounded-full h-1">
                          <div 
                            className="bg-blue-500 h-1 rounded-full transition-all duration-300"
                            style={{ width: `${Math.min((monthEntries.length / 30) * 100, 100)}%` }}
                          ></div>
                        </div>
                        <span className="text-white pixelated-text text-sm">{monthEntries.length}</span>
                      </div>
                    </div>
                  );
                })}
      ...
      case 'settings':
        return (
          <div className="space-y-6">
            {/* Settings Header */}
            <div className="text-center mb-6">
              <h1 className="text-3xl font-bold text-white pixelated-text mb-2">Settings</h1>
            ...
            <Card className="bg-slate-800/50 border-slate-600 text-white backdrop-blur-sm card-glass">
              <CardHeader>
                <CardTitle className="text-blue-300 pixelated-text">Account Settings</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 bg-slate-700/50 rounded-lg">
                  <div>
                    <h3 className="text-white pixelated-text font-semibold">Base Account</h3>
                    <p className="text-blue-300 pixelated-text text-sm">Connected</p>
                  </div>
                  <Badge className="bg-green-500/20 text-green-300 border-green-400/30 pixelated-text">
                    Active
                  </Badge>
            ...
            <Card className="bg-slate-800/50 border-slate-600 text-white backdrop-blur-sm card-glass">
              <CardHeader>
                <CardTitle className="text-blue-300 pixelated-text">Data Management</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-slate-700/50 rounded-lg">
                  <div>
            ...
            <Card className="bg-slate-800/50 border-slate-600 text-white backdrop-blur-sm card-glass">
              <CardHeader>
                <CardTitle className="text-blue-300 pixelated-text">Preferences</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-slate-700/50 rounded-lg">
                  <div>
                    <h3 className="text-white pixelated-text font-semibold">Theme</h3>
                    <p className="text-blue-300 pixelated-text text-sm">Dark mode (default)</p>
                  </div>
                  <Badge className="bg-blue-500/20 text-blue-300 border-blue-400/30 pixelated-text">
                    Dark
                  </Badge>
                ...
                <div className="flex items-center justify-between p-4 bg-slate-700/50 rounded-lg">
                  <div>
                    <h3 className="text-white pixelated-text font-semibold">Notifications</h3>
                    <p className="text-blue-300 pixelated-text text-sm">Daily reminders</p>
                  </div>
                  <Button
                    variant="outline"
                    size="sm"
            ...
            <Card className="bg-slate-800/50 border-slate-600 text-white backdrop-blur-sm card-glass">
              <CardHeader>
                <CardTitle className="text-blue-300 pixelated-text">About DailyBase</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="text-center py-4">
                  ...
                  />
                  <h3 className="text-xl font-semibold text-white pixelated-text mb-2">DailyBase</h3>
                  <p className="text-blue-300 pixelated-text mb-4">Your personal crypto journal</p>
                  <p className="text-sm text-blue-300/70 pixelated-text">Version 1.0.0</p>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="p-6 border-b border-white/20">
              <div className="flex items-center gap-3">
                ...
                />
                <h2 className="text-lg font-bold text-white pixelated-text">DailyBase</h2>
              </div>
              <div className="mt-4 space-y-2">
                <Badge variant="outline" className="bg-slate-800 border-blue-400 text-blue-300 shadow-sm pixelated-text text-xs">
